<h2><a href="https://leetcode.com/problems/count-subarrays-with-cost-less-than-or-equal-to-k">Count Subarrays With Cost Less Than or Equal to K</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code>, and an integer <code>k</code>.</p>
